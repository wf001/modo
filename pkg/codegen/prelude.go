...
var OperatorDispatchTable = map[OpKey]OpFunc{
	...
	{mTypes.OPERATOR_ADD, types.Double, types.Double}: PreludeFAdd,
	{mTypes.OPERATOR_SUB, types.I32, types.I32}:       PreludeSub,
	{mTypes.OPERATOR_SUB, types.Double, types.Double}: PreludeFSub,
	{mTypes.OPERATOR_MUL, types.I32, types.I32}:       PreludeMul,
	{mTypes.OPERATOR_MUL, types.Double, types.Double}: PreludeFMul,
	{mTypes.OPERATOR_DIV, types.I32, types.I32}:       PreludeDiv,
	{mTypes.OPERATOR_DIV, types.Double, types.Double}: PreludeFDiv,
	...
	{mTypes.OPERATOR_EQ, types.Double, types.Double}:  PreludeFEq,
	{mTypes.OPERATOR_GT, types.I32, types.I32}:        PreludeGt,
	{mTypes.OPERATOR_GT, types.Double, types.Double}:  PreludeFGt,
	{mTypes.OPERATOR_LT, types.I32, types.I32}:        PreludeLt,
	{mTypes.OPERATOR_LT, types.Double, types.Double}:  PreludeFLt,
	{mTypes.OPERATOR_MOD, types.I32, types.I32}:       PreludeMod,
	{mTypes.OPERATOR_MOD, types.Double, types.Double}: PreludeFMod,
}
