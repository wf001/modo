...
func PreludeUpdate(block *ir.Block, internal *mTypes.Internal, node *mTypes.Node) value.Value {
	return nil
}
func PreludeUpdateOld(block *ir.Block, internal *mTypes.Internal, node *mTypes.Node) value.Value {
